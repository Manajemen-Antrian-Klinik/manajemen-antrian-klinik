        ...
        <div class="col-span-2 space-y-6">
            ...
            <section class="grid grid-cols-4 gap-6">
                ...
                <div class="bg-gray-200 p-6 rounded-lg shadow-md text-center">
                    ...
                    <p class="text-3xl font-bold text-blue-700">{{ $queueData['total_quota'] ?? 20 }}</p>
                </div>
                <!-- Sisa Kuota -->
                <div class="bg-gray-200 p-6 rounded-lg shadow-md text-center">
                    <p class="text-gray-600 text-lg font-semibold">Sisa Kuota</p>
                    <p class="text-3xl font-bold text-blue-700">{{ $queueData['remaining_quota'] ?? 20 }}</p>
                </div>
                <!-- No Antrian Dilayani -->
                <div class="bg-gray-200 p-6 rounded-lg shadow-md text-center">
                    <p class="text-gray-600 text-lg font-semibold">No Antrian Dilayani</p>
                    <p class="text-3xl font-bold text-blue-700">{{ $queueData['current_queue'] ?? '-' }}</p>
                </div>
                <!-- Selesai Dilayani -->
                <div class="bg-gray-200 p-6 rounded-lg shadow-md text-center">
                    <p class="text-gray-600 text-lg font-semibold">Selesai Dilayani</p>
                    <p class="text-3xl font-bold text-blue-700">{{ $queueData['completed_queues'] ?? 0 }}</p>
                </div>
            </section>
        </div>
