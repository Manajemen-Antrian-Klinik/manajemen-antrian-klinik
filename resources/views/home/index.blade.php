    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div class="col-span-2 space-y-6">
            ...
            <section class="grid grid-cols-4 gap-6">
                <!-- Kuota -->
                <div class="bg-[#6B5B95] p-6 rounded-lg shadow-md text-center">
        ...
        <div class="bg-gray-100 p-6 rounded-lg shadow-md flex flex-col items-center justify-center">
            @if($userQueue = Auth::user()->queues()->where('date', today()->format('Y-m-d'))->first())
                <div class="text-center">
                    <p class="text-gray-600 text-lg mb-2">Nomor Antrian Anda</p>
                    <p class="text-6xl font-bold text-blue-700">{{ $userQueue->queue_number }}</p>
                </div>
            @else
                <div class="text-center">
                    <p class="text-gray-600">Anda belum memiliki antrian hari ini</p>
